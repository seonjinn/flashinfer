...
CONTROL_ROOT=${CONTROL_ROOT:-/home/sna/flashinfer-pr4657-4684-combined/experiments/pr4657_pr4684_model_generalization}
...
RESULT_ROOT=${RESULT_ROOT:-/lustre/fsw/coreai_dlalgo_llm/users/sna/flashinfer-pr4657-4684-model-generalization/${STAMP}}
...
args=(
  ...
  --nodes=1
  --time=04:00:00
  --job-name=coreai_dlalgo_llm-flashinfer.model-generalization
